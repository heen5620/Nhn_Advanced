...
public class FractionalTest {
    ...
    public static void main(String[] args) {
        ...
        for (Fractional r : rs) {
            ...
            // System.out.println(
            // Mathx.<String>reduceIf(x -> true, (s, s2) -> s + s2, "", "a", "b", "c"));

        }
        // Fractional r = rs[0];
        // Object e = rs[1];
        // r.equals(e);
        System.out.println(Mathx.reduceIf(x -> true, Fractional::add, rs[0], rs[1], rs[2], rs[3])); // 람다식으로
        // System.out.println(Mathx.reduceIf(null,null,null,null)); // 람다식으로
    }
